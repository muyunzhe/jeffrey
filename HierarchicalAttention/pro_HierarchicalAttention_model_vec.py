...
class HierarchicalAttention:
    def __init__(self, num_classes, learning_rate, batch_size, decay_steps, decay_rate, max_sentence_num, max_sentence_length,
        ...
        self.learning_rate_decay_half_op = tf.assign(self.learning_rate, self.learning_rate * 0.8)
        ...
        #sequence_length
        self.sequence_length = self.max_sentence_length
        ...
        self.document_representation, self.logits = self.inference()  # [None, self.label_size]. main computation graph is here.
    ...
    def attention_sentence_level(self, hidden_state_sentence):
        ...
        hidden_representation = tf.reshape(hidden_representation, shape=[-1, self.max_sentence_num,
    ...
    def inference(self):
        ...
        #print self.embedded_words.get_shap()
        ...
        print embedded_words_reshaped.shape
        # 1.2 forward gru
        ...
        print len(hidden_state_forward_list)
        print hidden_state_forward_list[0].shape
        # 1.3 backward gru
        ...
        sentence_representation = tf.reshape(sentence_representation, shape=[-1, self.max_sentence_num, self.hidden_size * 2])  # shape:[batch_size,num_sentences,hidden_size*2]
        ...
        #tf.Print(document_representation, [document_representation])
        ...
        return document_representation, logits
    ...
    def gru_forward_word_level(self, embedded_words):
        ...
        h_t = tf.ones((self.batch_size * self.max_sentence_num,
    ...
    def gru_backward_word_level(self, embedded_words):
        ...
        h_t = tf.ones((self.batch_size * self.max_sentence_num, self.hidden_size))
        h_t_backward_list = []
    ...
    def gru_forward_sentence_level(self, sentence_representation):
        ...
        """
        # split embedded_words
        sentence_representation_splitted = tf.split(sentence_representation, self.max_sentence_num,
...
def test():
    ...
    textRNN = HierarchicalAttention(num_classes, 
                                    learning_rate, 
                                    batch_size, 
                                    decay_steps, 
                                    decay_rate, 
    ...
    with tf.Session() as sess:
        ...
        for i in range(100):
            ...
            input_x = np.zeros((batch_size, max_sentence_num, max_sentence_length)) #num_sentences
