...
if __name__ == "__main__":
    ...
    ann_path = sys.argv[2]
    pkl_path = sys.argv[3]
    ans = AnnoySearch(input_file=vec_path, vec_dim=100) 
    ans.build_tree() 
    
    ans.save_tree(ann_path, pkl_path)
    #ans = AnnoySearch(model_path=annoy_dir+'/model_path/title_ngram.ann', dict_path=annoy_dir+'/model_path/title_ngram_id_index.pkl', vec_dim=128)
